...
# Scenario with profit sharing system (Tesang) ####
  
  # In this scenario, small farmers don't own land so they need to work with big
  # farmers who own land. There are some types of profit sharing system in Sinjai.
  # The most common one is that the small farmers work on the field with their 
  # family (so labor cost may not be considered), while the land owners provide
  # capital for farming costs. The profits then would be divided into 50:50 for
  # small farmers and land owners, after subtracting the costs.
  ...
  # The income will be divided into 50:50 for small farmer and land owner
  
  # Rice farming income
  rice_farming_income <- (final_rice_farming_revenue - final_rice_farming_cost)/2
  
  # Rice compost income
  rice_compost_income <- (final_rice_compost_revenue - final_rice_farming_cost)/2
  
  # Rice processed production income
  rice_processed_income <- (processed_rice_product_revenue - processed_rice_product_cost)/2
  
  # Rice eco-tourism income 
  rice_ecotourism_income <- (rice_ecotourism_revenue - rice_ecotourism_cost)/2
  ...
  # In case of vegetables, the land owner sometimes provide capital for labor costs
  # So here, the labor cost still calculated as costs.
  ...
  # Which is included for the cost of labor, compost activator, and maintenance
  annual_vegetable_compost_cost <- annual_cost_labor_vegetable_composting +
    compost_activator_cost + composter_maintenance_cost
  
  vegetable_compost_cost <- vv(annual_vegetable_compost_cost, n_year, var_CV=5)
  ...
  vegetable_farming_income <- (final_vegetable_farming_revenue - final_vegetable_farming_cost)/2
  
  # Vegetables compost income
  vegetable_compost_income <- (final_vegetable_compost_revenue - final_vegetable_compost_cost)/2
  
  # Vegetables processed production income
  vegetable_processed_income <- (final_vegetable_processed_revenue - final_vegetable_processing_cost)/2
  
  # Vegetables eco-tourism income 
  vegetable_ecotourism_income <- (vegetables_ecotourism_revenue - vegetable_ecotourism_cost)/2
  ...
  return(list(NPV_rice = NPV_rice,
              ...
              NPV_decision = NPV_vegetables - NPV_rice,
...
# Plot cashflow rice farming
cashflow_rice_farming <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_rice_farming",
                                       x_axis_name = "Years with intervention",
                                       y_axis_name = "Annual cashflow in USD",
                                       color_25_75 = "skyblue", color_5_95 = "wheat",
                                       color_median = "red")

# Plot cashflow vegetables farming
cashflow_vegetables_farming <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_vegetables_farming",
                                             x_axis_name = "Years with intervention",
                                             y_axis_name = "Annual cashflow in USD",
                                             color_25_75 = "seagreen2", color_5_95 = "wheat",
                                             color_median = "red")
...
# Plot cashflow rice compost
cashflow_rice_compost <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_rice_compost",
                                       x_axis_name = "Years with intervention",
                                       y_axis_name = "Annual cashflow in USD",
                                       color_25_75 = "skyblue", color_5_95 = "wheat",
                                       color_median = "red")

# Plot cashflow vegetables compost
cashflow_vegetable_compost <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_vegetable_compost",
                                            x_axis_name = "Years with intervention",
                                            y_axis_name = "Annual cashflow in USD",
                                            color_25_75 = "seagreen2", color_5_95 = "wheat",
                                            color_median = "red")

# Plot cashflow rice processed
cashflow_rice_processed <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_rice_processed",
                                         x_axis_name = "Years with intervention",
                                         y_axis_name = "Annual cashflow in USD",
                                         color_25_75 = "skyblue", color_5_95 = "wheat",
                                         color_median = "red")

# Plot cashflow vegetables processed
cashflow_vegetable_processed <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_vegetable_processed",
                                              x_axis_name = "Years with intervention",
                                              y_axis_name = "Annual cashflow in USD",
                                              color_25_75 = "seagreen2", color_5_95 = "wheat",
                                              color_median = "red")
...
# Plot cashflow rice ecotourism
cashflow_rice_ecotourism <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_rice_ecotourism",
                                          x_axis_name = "Years with intervention",
                                          y_axis_name = "Annual cashflow in USD",
                                          color_25_75 = "skyblue", color_5_95 = "wheat",
                                          color_median = "red")
...
# Plot cashflow vegetables processed
cashflow_vegetable_ecotourism <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_vegetable_ecotourism",
                                               x_axis_name = "Years with intervention",
                                               y_axis_name = "Annual cashflow in USD",
                                               color_25_75 = "seagreen2", color_5_95 = "wheat",
                                               color_median = "red")
...
# Plot cashflow rice health
cashflow_rice_health <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_rice_health",
                                      x_axis_name = "Years with intervention",
                                      y_axis_name = "Annual cashflow in USD",
                                      color_25_75 = "skyblue", color_5_95 = "wheat",
                                      color_median = "red")

# Plot cashflow vegetables health
cashflow_vegetable_health <- plot_cashflow(mcSimulation_object = TRV_mc_simulation, cashflow_var_name = "cashflow_vegetable_health",
                                           x_axis_name = "Years with intervention",
                                           y_axis_name = "Annual cashflow in USD",
                                           color_25_75 = "seagreen2", color_5_95 = "wheat",
                                           color_median = "red")
...
compound_figures_cashflow_1 <- (cashflow_rice | cashflow_vegetables) / 
...
# Plot PLS rice farming
pls_result_rice_farming <- plsr.mcSimulation(object = TRV_mc_simulation,
                                             resultName = names(TRV_mc_simulation$y)[4], ncomp = 1)
plot_pls_rice_farming <- plot_pls(pls_result_rice_farming, threshold = 0.5, base_size = 10,
                                  pos_color = "skyblue", neg_color = "firebrick3")+
  labs(title = "PLS Rice Farming", size = 8)

# Plot PLS vegetables farming
pls_result_vegetables_farming <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                   resultName = names(TRV_mc_simulation$y)[5], ncomp = 1)
plot_pls_vegetables_farming <- plot_pls(pls_result_vegetables_farming, threshold = 0.5, base_size = 10,
                                        pos_color = "seagreen2", neg_color = "firebrick3")+
  labs(title = "PLS Vegetables Farming", size = 8)

# Plot PLS rice compost
pls_result_rice_compost <- plsr.mcSimulation(object = TRV_mc_simulation,
                                             resultName = names(TRV_mc_simulation$y)[6], ncomp = 1)
plot_pls_rice_compost <- plot_pls(pls_result_rice_compost, threshold = 0.5, base_size = 10,
                                  pos_color = "skyblue", neg_color = "firebrick3")+
  labs(title = "PLS Rice Compost", size = 8)

# Plot PLS vegetables compost
pls_result_vegetables_compost <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                   resultName = names(TRV_mc_simulation$y)[7], ncomp = 1)
plot_pls_vegetables_compost <- plot_pls(pls_result_vegetables_compost, threshold = 0.5, base_size = 10,
                                        pos_color = "seagreen2", neg_color = "firebrick3")+
  labs(title = "PLS Vegetables Compost", size = 8)

# Plot PLS rice processed
pls_result_rice_processed <- plsr.mcSimulation(object = TRV_mc_simulation,
                                               resultName = names(TRV_mc_simulation$y)[8], ncomp = 1)
plot_pls_rice_processed <- plot_pls(pls_result_rice_processed, threshold = 0.5, base_size = 10,
                                    pos_color = "skyblue", neg_color = "firebrick3")+
  labs(title = "PLS Rice Processed", size = 8)

# Plot PLS vegetables processed
pls_result_vegetables_processed <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                     resultName = names(TRV_mc_simulation$y)[9], ncomp = 1)
plot_pls_vegetables_processed <- plot_pls(pls_result_vegetables_processed, threshold = 0.5, base_size = 10,
                                          pos_color = "seagreen2", neg_color = "firebrick3")+
  labs(title = "PLS Vegetables Processed", size = 8)

# Plot PLS rice ecotourism
pls_result_rice_ecotourism <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                resultName = names(TRV_mc_simulation$y)[10], ncomp = 1)
plot_pls_rice_ecotourism <- plot_pls(pls_result_rice_ecotourism, threshold = 0.5, base_size = 10,
                                     pos_color = "skyblue", neg_color = "firebrick3")+
  labs(title = "PLS Rice Ecotourism", size = 8)

# Plot PLS vegetables ecotourism
pls_result_vegetables_ecotourism <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                      resultName = names(TRV_mc_simulation$y)[11], ncomp = 1)
plot_pls_vegetables_ecotourism <- plot_pls(pls_result_vegetables_ecotourism, threshold = 0.5, base_size = 10,
                                           pos_color = "seagreen2", neg_color = "firebrick3")+
  labs(title = "PLS Vegetables Ecotourism", size = 8)

# Plot PLS rice health
pls_result_rice_health <- plsr.mcSimulation(object = TRV_mc_simulation,
                                            resultName = names(TRV_mc_simulation$y)[12], ncomp = 1)
plot_pls_rice_health <- plot_pls(pls_result_rice_health, threshold = 0.5, base_size = 10,
                                 pos_color = "skyblue", neg_color = "firebrick3")+
  labs(title = "PLS Rice Health", size = 8)

# Plot PLS vegetables health
pls_result_vegetables_health <- plsr.mcSimulation(object = TRV_mc_simulation,
                                                  resultName = names(TRV_mc_simulation$y)[13], ncomp = 1)
plot_pls_vegetables_health <- plot_pls(pls_result_vegetables_health, threshold = 0.5, base_size = 10,
                                       pos_color = "seagreen2", neg_color = "firebrick3")+
  labs(title = "PLS Vegetables Health", size = 8)


# Compund PLS figures

compound_figures_PLS_1 <- (plot_pls_rice | plot_pls_vegetables) / 
  (plot_pls_rice_farming | plot_pls_vegetables_farming) 


compound_figures_PLS_2 <- (plot_pls_rice_compost | plot_pls_vegetables_compost) /
...
# VoI analysis ####
mcSimulation_table <- data.frame(TRV_mc_simulation$x, TRV_mc_simulation$y[1:13])
...
compound_figures_evpi <- (plot_evpi_vegetables_processed | plot_evpi_vegetables_processed)/
...
compound_figure_rice_farming <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                input_table = input_estimates, plsrResults = pls_result_rice, 
                                                EVPIresults = evpi_TRV, decision_var_name = "NPV_rice_farming", 
                                                cashflow_var_name = "cashflow_rice_farming", 
                                                base_size = 7)

compound_figure_vegetables_farming <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                      input_table = input_estimates, plsrResults = pls_result_vegetables, 
                                                      EVPIresults = evpi_TRV, decision_var_name = "NPV_vegetables_farming", 
                                                      cashflow_var_name = "cashflow_vegetables_farming", 
                                                      base_size = 7)

compound_figure_rice_compost <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                input_table = input_estimates, plsrResults = pls_result_rice, 
                                                EVPIresults = evpi_TRV, decision_var_name = "NPV_rice_compost", 
                                                cashflow_var_name = "cashflow_rice_compost", 
                                                base_size = 7)

compound_figure_vegetables_compost <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                      input_table = input_estimates, plsrResults = pls_result_vegetables, 
                                                      EVPIresults = evpi_TRV, decision_var_name = "NPV_vegetable_compost", 
                                                      cashflow_var_name = "cashflow_vegetable_compost", 
                                                      base_size = 7)

compound_figure_rice_processed <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                  input_table = input_estimates, plsrResults = pls_result_rice, 
                                                  EVPIresults = evpi_TRV, decision_var_name = "NPV_rice_processed", 
                                                  cashflow_var_name = "cashflow_rice_processed", 
                                                  base_size = 7)

compound_figure_vegetables_processed <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                        input_table = input_estimates, plsrResults = pls_result_vegetables, 
                                                        EVPIresults = evpi_TRV, decision_var_name = "NPV_vegetable_processed", 
                                                        cashflow_var_name = "cashflow_vegetable_processed", 
                                                        base_size = 7)

compound_figure_rice_ecotourism <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                   input_table = input_estimates, plsrResults = pls_result_rice, 
                                                   EVPIresults = evpi_TRV, decision_var_name = "NPV_rice_ecotourism", 
                                                   cashflow_var_name = "cashflow_rice_ecotourism", 
                                                   base_size = 7)

compound_figure_vegetables_ecotourism <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                         input_table = input_estimates, plsrResults = pls_result_vegetables, 
                                                         EVPIresults = evpi_TRV, decision_var_name = "NPV_vegetable_ecotourism", 
                                                         cashflow_var_name = "cashflow_vegetable_ecotourism", 
                                                         base_size = 7)

compound_figure_rice_health <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                               input_table = input_estimates, plsrResults = pls_result_rice, 
                                               EVPIresults = evpi_TRV, decision_var_name = "NPV_rice_health", 
                                               cashflow_var_name = "cashflow_rice_health", 
                                               base_size = 7)

compound_figure_vegetables_health <- compound_figure(mcSimulation_object = TRV_mc_simulation, 
                                                     input_table = input_estimates, plsrResults = pls_result_vegetables, 
