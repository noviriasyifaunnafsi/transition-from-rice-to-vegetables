...
transition_rice_to_vegetables <- function(x, varnames){
  ...
  # event-3 rice revenue reduction from market risk under normal condition
  ...
  # event-4 rice revenue reduction from market risk under production risk
  ...
  final_rice_farming_revenue_with_risk <- rice_farming_revenue_with_market_production_risk + rice_farming_revenue_with_market_financial_risk
  ...
  return(list(NPV_rice_all_options = NPV_rice,
              NPV_vegetables_all_options = NPV_vegetables,
              ...
              cashflow_rice_all_options = rice_result,
              cashflow_vegetables_all_options = vegetable_result,
