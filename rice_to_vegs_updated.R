...
transition_rice_to_vegetables <- function(x, varnames){
  ...
  ### total costs both rice and vegetables 
  ...
  chinese_mustard_green_income <- (chinese_mustard_green_yield*chinese_mustard_green_price) * 0.8 #assuming it is cultivated in 0.3 ha for each season and twice per year
  green_bean_income <- (green_bean_yield*green_bean_price) *  0.8 #assuming it is cultivated in 0.5 ha for each season and once per year
  cabbage_income <- (cabbage_yield*cabbage_price) * 0.8 ##assuming it is cultivated in 0.3 ha for each season and twice per year
  ...
  rice_vegetables_water_value <- vv(rice_vegetables_water_value_precal, #value of water used for production (IDR/ha)
