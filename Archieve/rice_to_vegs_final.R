...
transition_rice_to_vegetables <- function(x, varnames)
{
  ...
  chance_production_risk_rice_benefits_with_gov_assistance <- 
      chance_event(chance = chance_production_risk, value_if = 1, 
                   value_if_not = 0) 
    
  if(chance_production_risk_rice_benefits_with_gov_assistance == 1){  
  ...
  rice_tudang_sipulung_with_gov_assistance_precal <- 
    rice_cultural_value_proxy_local_cultural_practice_tudang_sipulung * 
    (rice_farming_input_costs_with_gov_assistance + 
       rice_machinery_costs_with_gov_assistance + irrigation_maintenance_costs)
  
  rice_tudang_sipulung_with_gov_assistance <- 
    vv(rice_tudang_sipulung_with_gov_assistance_precal, 
       n_year, 
       var_CV=CV_value, 
       relative_trend = inflation_rate)
  ...
  rice_gotong_royong_with_gov_assistance_precal <- 
    rice_cultural_value_proxy_local_cultural_practice_gotong_royong *
    rice_labor_costs
  
  rice_gotong_royong_with_gov_assistance <-
    vv(rice_gotong_royong_with_gov_assistance_precal,
       n_year, 
       var_CV=CV_value, 
       relative_trend = inflation_rate)
  ...
  if(chance_risk_vegetable_farming_high_input_cost_with_bank_loan == 1){
    ...
    vegetable_farming_high_input_cost_with_bank_loan_with_gov_assistance <- 
      vv((vegetables_farming_input_costs_with_gov_assistance_vv -
            (vegetables_farming_input_costs_with_gov_assistance_vv * annual_bank_interest)),
         n_year, var_CV=10, relative_trend = inflation_rate)
    
    # annual_final_vegetable_farming_high_input_cost_with_bank_loan_with_gov_assistance <- 
    #   vv((vegetable_farming_high_input_cost_with_bank_loan_with_gov_assistance * 2.5), # effective field size
    #      n_year, var_CV=CV_value, relative_trend = inflation_rate)
    
    vegetable_farming_high_input_cost_with_bank_loan_with_gov_assistance[1] <- 
      vegetable_farming_high_input_cost_with_bank_loan_with_gov_assistance[1] + 
      vegetables_equipment_costs_first_year_with_gov_assistance + 
      vegetables_irrigation_costs_first_year_with_gov_assistance
  ...
  if(chance_institutional_vegetable_rice_with_gov_assistance == 1){
    ...
    # annual_final_vegetable_farming_cost_with_institutional_risk_with_gov_assistance <- 
    #   vv((vegetable_farming_input_costs_with_institutional_risk, # * 2.5), # effective field size
    #      n_year, var_CV=CV_value, relative_trend = inflation_rate)
    
    vegetable_farming_input_costs_with_institutional_risk[1] <- 
      vegetable_farming_input_costs_with_institutional_risk[1] + 
      vegetables_equipment_costs_first_year_with_gov_assistance + 
      vegetables_irrigation_costs_first_year_with_gov_assistance
  ...
  chance_risk_vegetable_farming_costs_all_risks <- 
    chance_event(chance = 0.01, value_if = 1, 
                 value_if_not = 0) 
  
  if(chance_risk_vegetable_farming_costs_all_risks == 1){
    ...
    #   vv(vegetable_farming_cost_with_all_risks, # * 2.5, # effective field size
    #      n_year, var_CV=CV_value, relative_trend = inflation_rate)
    ...
    final_vegetable_farming_cost_with_gov_assistance <- vegetables_farming_cost_with_gov_assistance
} 
  ...
  if(chance_risk_rice_farming_high_input_cost == 1){
    ...
    rice_farming_input_costs_with_more_pesticides_without_gov_assistance <- 
      vv(rice_farming_cost_without_gov_assistance, 
         n_year, var_CV= CV_value, relative_trend = inflation_rate)
  }
  ...
  # # Consider institutional risk to cost with government asssitance
  # chance_institutional_risk_rice_without_gov_assistance <- 
  #   chance_event(chance = chance_institutional_risk, value_if = 1, 
  #                value_if_not = 0) 
  # 
  # if(chance_institutional_risk_rice_without_gov_assistance == 1){
  #   
  #   # Farming input costs may increase due to institutional risks
  #   rice_farming_input_costs_with_institutional_risk <- 
  #     rice_farming_high_input_cost_with_bank_loan_with_gov_assistance +
  ...
  # }else{
  #   rice_farming_input_costs_with_more_pesticides_without_gov_assistance <- 
  #     vv(rice_farming_input_costs, n_year, var_CV= CV_value, relative_trend = inflation_rate)
  # }
  # 
  # 
  # 
  ...
  #   
  #   rice_farming_high_input_cost_with_bank_loan_without_gov_assistance <- 
  #     vv(((rice_farming_input_costs_with_more_pesticides_without_gov_assistance +
  #        rice_machinery_costs + rice_labor_costs) * annual_bank_interest), 
  #   n_year, var_CV= CV_value, relative_trend = inflation_rate)
  #   
  #   # rice_farming_high_input_cost_with_bank_loan_without_gov_assistance <- 
  #   #   vv(rice_farming_high_input_cost_with_bank_loan_without_gov_assistance_precal,
  ...
  rice_revenue_with_production_financial_risk_without_gov_assistance <- 
    vv((rice_yield - (rice_yield * 
    (prob_damage_production_risk_rice + prob_damage_market_risk_rice))), 
    n_year, var_CV=CV_value, relative_trend = inflation_rate) 
  ...
  # (without natural risks)
  # rice_farming_revenue_with_market_risk_normal <- 
  #   vv(((rice_farmgate_price * prob_damage_market_risk_rice) * rice_yield),
  # n_year, var_CV=CV_value, relative_trend = inflation_rate)
  # 
  # rice_farming_revenue_loss_with_market_risk_normal <-
  #   vv((rice_farmgate_price_with_market_risk * rice_yield), n=n_year,
  ...
  # 
  # }else{
  #   rice_farming_revenue_with_market_risk_normal <- rice_farming_revenue
  # }
  ...
  # financial risk
  #   
  # chance_market_risk_with_production_and_financial_risk_rice_without_gov_assistance <- 
  #   chance_event(chance = chance_production_risk + chance_market_risk_rice, 
  #                  value_if = 1, 
  #                  value_if_not = 0) 
  #   
  # if(chance_market_risk_with_production_and_financial_risk_rice_without_gov_assistance == 1){      
  #     
  #     
  #   
  # rice_farming_revenue_loss_with_market_production_financial_risk <- 
  ...
  # as they can be more efficiently manage their rice farming in each season
  # so that they can avoid a big issue that might be comes from pests and disease
  # so we can estimate this like by thinkig there will be lower costs for crop 
  # protection, let's say maybe around 5-10% decrease.
  
  # rice_tudang_sipulung_without_gov_assistance_precal <- 
  #   rice_cultural_value_proxy_local_cultural_practice_tudang_sipulung * 
  #   (rice_farming_input_costs + 
  #      rice_machinery_costs + 
  #      irrigation_maintenance_costs)
  ...
  #   vv(rice_tudang_sipulung_without_gov_assistance_precal, 
  #      n_year, 
  #      var_CV=CV_value, 
  #      relative_trend = inflation_rate)
  ...
  # rice_gotong_royong_without_gov_assistance_precal <- 
  #   rice_cultural_value_proxy_local_cultural_practice_gotong_royong *
  #   rice_labor_costs
  # 
  # rice_gotong_royong_without_gov_assistance <-
  #   vv(rice_gotong_royong_without_gov_assistance_precal,
  #      n_year, 
  #      var_CV=CV_value, 
  #      relative_trend = inflation_rate)
  # 
  ...
  chance_risk_vegetable_farming_high_input_cost_without_gov_assistance <- 
    chance_event(chance = chance_production_risk, value_if = 1, 
                 value_if_not = 0) 
  
  if(chance_risk_vegetable_farming_high_input_cost_without_gov_assistance == 1){
    ...
    final_vegetable_farming_input_cost_without_gov_assistance <- 
      vv(vegetable_farming_input_costs_with_more_pesticides_without_gov_assistance, 
         n_year, var_CV=CV_value, relative_trend = inflation_rate)
    
    final_vegetable_farming_input_cost_without_gov_assistance[1] <- 
...
pls_result_vegetables_both <- 
  plsr.mcSimulation(object = TRV_mc_simulation,
                    resultName = names(TRV_mc_simulation$y)[1:2], ncomp = 2)
...
# Subset the outputs from the mcSimulation function (y) to summarize only on 
# the variables that we want.

# names(TRV_mc_simulation$x)
mcSimulation_summary <- data.frame(TRV_mc_simulation$x[5:69],
                                   # names(TRV_mc_simulation$x)
                                   TRV_mc_simulation$y[2])
