...
transition_rice_to_vegetables <- function(){
  ...
  scaled_rice_income_precal <- (rice_income - min_rice_income) / (max_rice_income - min_rice_income)
  ...
  scaled_rice_water_use_precal <- (rice_water_use - min_rice_water_use) / (max_rice_income - min_rice_income)
  ...
  scaled_rice_nutrition_precal <- (rice_nutrition - min_rice_nutrition) / (max_rice_income - min_rice_income)
  ...
  scaled_potato_income_precal <- (potato_income - min_potato_income) / (max_potato_income - min_potato_income)
  ...
  scaled_potato_water_use_precal <- (potato_water_use - min_potato_water_use) / (max_potato_income - min_potato_income)
  ...
  scaled_potato_nutrition_precal <- (potato_nutrition - min_potato_nutrition) / (max_potato_income - min_potato_income)
  ...
  scaled_shallot_income_precal <- (shallot_income - min_shallot_income) / (max_shallot_income - min_shallot_income)
  ...
  scaled_shallot_water_use_precal <- (shallot_water_use - min_shallot_water_use) / (max_shallot_income - min_shallot_income)
  ...
  scaled_shallot_nutrition_precal <- (shallot_nutrition - min_shallot_nutrition) / (max_shallot_income - min_shallot_income)
  ...
  scaled_chili_income_precal <- (chili_income - min_chili_income) / (max_chili_income - min_chili_income)
  ...
  scaled_chili_water_use_precal <- (chili_water_use - min_chili_water_use) / (max_chili_income - min_chili_income)
  ...
  scaled_chili_nutrition_precal <- (chili_nutrition - min_chili_nutrition) / (max_chili_income - min_chili_income)
  ...
  scaled_carrot_income_precal <- (carrot_income - min_carrot_income) / (max_carrot_income - min_carrot_income)
  ...
  scaled_carrot_water_use_precal <- (carrot_water_use - min_carrot_water_use) / (max_carrot_income - min_carrot_income)
  ...
  scaled_carrot_nutrition_precal <- (carrot_nutrition - min_carrot_nutrition) / (max_carrot_income - min_carrot_income)
  ...
  scaled_cabbage_income_precal <- (cabbage_income - min_cabbage_income) / (max_cabbage_income - min_cabbage_income)
  ...
  scaled_cabbage_water_use_precal <- (cabbage_water_use - min_cabbage_water_use) / (max_cabbage_income - min_cabbage_income)
  ...
  scaled_cabbage_nutrition_precal <- (cabbage_nutrition - min_cabbage_nutrition) / (max_cabbage_income - min_cabbage_income)
